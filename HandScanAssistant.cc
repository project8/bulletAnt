...
std::string MyMainFrame::GetUserInput()
{
    return userInput;
}


void MyMainFrame::OkayButton()
{
...
void MyMainFrame::CreateDialog(const std::string &userPrompt )
{
   ...
   b->Connect("Clicked()","MyMainFrame",this,"OkayButton()");
   b->Associate(fDialog);
   hf->AddFrame(b, l3);
   ...
   b->Connect("Clicked()","MyMainFrame",this,"CancelButton()");
   b->Associate(fDialog);
   hf->AddFrame(b, l3);
   height = b->GetDefaultHeight();
   width = b->GetDefaultWidth();
