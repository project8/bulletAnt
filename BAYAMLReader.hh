...
void BAYAMLReader::ReadTracks()
{
    ...
    while (std::getline(fileStream, currentLine)) 
    {
       ...
       else if ((currentLine.find(curvesHead) != std::string::npos) || (currentLine.find(othersHead) != std::string::npos))
       {
           break;
       }
    }
...
void BAYAMLReader::ReadCurves()
{
    ...
    while (std::getline(fileStream, currentLine)) 
    {
       ...
       else if ((currentLine.find(tracksHead) != std::string::npos) || (currentLine.find(othersHead) != std::string::npos))
       {
           break;
       }
    }
...
void BAYAMLReader::ReadOthers()
{
    ...
    while (std::getline(fileStream, currentLine)) 
    {
       ...
       else if ((currentLine.find(curvesHead) != std::string::npos) || (currentLine.find(tracksHead) != std::string::npos))
       {
           break;
       }
    }
